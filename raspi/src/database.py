...
class DatabaseManager:
    ...
    def createTables(self):
        """
        Creates tables.
        boxes: all boxes (might be unnecessary)
...
if __name__ == "__main__":
    ...
    db_manager = DatabaseManager('raspi/src/database.db')
    ...
    # Fetching one packet by its id
    db_manager.getById(1)
    # Fetching packets in a specific box
    db_manager.getPacketsInBox(2)
    # Emptying a specific box
